        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed font-medium">
              نخبة تسكين العقارية شركة ذات مسؤولية محدودة، متخصصة في إدارة الاستثمار العقاري وتطوير المشاريع، نعمل على تحويل الأفكار إلى فرص استثمارية ناجحة من خلال التخطيط الاستراتيجي، والتحليل المالي، والإدارة الاحترافية للأصول.
            </p>
